...
public class MemberController {
	...
	public ModelAndView findMemberDetail(@RequestParam String id) {
	...
	public ModelAndView registerForm() {
		log.info(
				"========================== MemberController(/member/register-form) ==================================");
		ModelAndView mv = new ModelAndView("/member/registerForm");
		return mv;
	}

	@RequestMapping("/member/register")
	public ModelAndView registerMember(MemberDTO dto, HttpServletRequest request) {
	...
	public ModelAndView removeMember(@RequestParam String id, HttpServletRequest request) {
